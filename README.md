...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dtool_info-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6460&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dtool_info-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dtool_info` can be installed with:

```
conda install dtool_info
```

It is possible to list all of the versions of `dtool_info` available on your platform with:
